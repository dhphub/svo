...
const double cu = 607.19;
//const double cv = 185.21;
...
void get3dPairs(const Mat& disMap_1,const Mat& disMap_2,const vector<Point2f>keypoints_1,
    ...
    reprojectImageTo3D(disMap_1,_3dPointsImage_1,Q);
    reprojectImageTo3D(disMap_2,_3dPointsImage_2,Q);
    for(int i=0;i<keypoints_1.size();i++){
        float x1,y1,z1,x2,y2,z2;
        x1 = _3dPointsImage_1.at<Vec3f>(keypoints_1.at(i))[0];
        y1 = _3dPointsImage_1.at<Vec3f>(keypoints_1.at(i))[1];
        z1 = _3dPointsImage_1.at<Vec3f>(keypoints_1.at(i))[2];
        x2 = _3dPointsImage_2.at<Vec3f>(keypoints_2.at(i))[0];
        y2 = _3dPointsImage_2.at<Vec3f>(keypoints_2.at(i))[1];
        z2 = _3dPointsImage_2.at<Vec3f>(keypoints_2.at(i))[2];
        if(z1 == 0 || z2 == 0)
            continue;
